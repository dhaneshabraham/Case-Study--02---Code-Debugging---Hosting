...
const nav= [
    ...
    {
        link:"/authers/addauthor",  //Part #2 Point 6
        title:"Add Author"
    }
]
...
const homeRouter = require('./src/routes/homeroute');(nav);  //Part #1 Point 3,Part #2 Point 6
...
const port =process.env.port || 3000;   //Part#1 Point 5
app.listen(port,()=>{
